...
# Description : Simple CiteULike operations. Access granted through
#               Firefox cookies.
# ====================================================================
import os
import sys
...
def citeULikeKeys(refs):
    """
    Retrieves json output and returns a dict structure based on the citation
    key
...
if __name__ == '__main__':
    ...
    if output is None:
        ...
        output = output[:-5] + \
            output[-5:].replace('.bib', '').replace('.json', '')
